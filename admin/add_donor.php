...
<body class="font-poppins">
    ...
    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
        ?>
        <main class="sm:flex">
            <section> <?php include('sidebar.php'); ?></section>

            <section class="md:container md:mx-auto">
                <!-- Table -->
                <div class="py-16 px-4 ">
                    <h3 class="text-5xl mb-12 font-semibold text-center">Add <span class="text-blood-primary">Donate</span>
                    </h3>
                    ...
                    <form class="mx-auto" name="donars" action="savedata.php" method="post">
                        ...
                        <div class="relative z-10 w-full mb-5 group">
                            <!--  <button type="submit"
                            class="text-white bg-[#DE3163] hover:bg-[#f82561]focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button> -->
                            <button>
                                <h3 type="submit"
